  ...
  return (
    <div className="bg-gradient-to-br from-[#394F68] to-[#183B7E] min-h-screen flex flex-col items-center justify-center text-slate-500">
      <div className="flex items-center justify-evenly">
        <SunIcon
          className="h-24 w-24 text-yellow-500 animate-spin"
          color="yellow"
        />
        <CloudIcon
          className="h-24 w-24 text-gray-500 animate-bounce"
          color="gray"
        />
        <LightningBoltIcon
        ...
        />
        <CloudIcon
          className="h-24 w-24 text-slate-50 animate-bounce"
          color="slate"
        />
        <MoonIcon
          className="h-24 w-24 text-slate-50 animate-spin"
          color="slate"
        />
      </div>
